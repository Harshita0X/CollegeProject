      ...
      <div className="db-profile-wrap">
        <div className="db-profile-card">
          ...
          <div className="db-profile-info">
            <p className="db-profile-name">{user?.name || 'Faculty Member'}</p>
            <div className="db-profile-table">
              <span className="db-profile-key">Position</span>
              <span className="db-profile-val">
                <span className="db-role-badge faculty">Faculty</span>
              </span>
          ...
          <div className="db-cards">
            {bookings.map((b) => (
              <div key={b._id} className="db-card">
                ...
                <div className="db-row">
                  <span className="db-row-label">Purpose</span>
                  <span className="db-row-val" style={{ textTransform: 'capitalize' }}>{b.purpose}</span>
                </div>
              </div>
            ))}
          </div>
