...
export default function Booking() {
  ...
  const handleSubmit = async () => {
    ...
    // Persistence Sync
    const tlRaw = ["9:00 AM", "10:00 AM", "11:00 AM", "2:00 PM", "3:00 PM", "4:00 PM"][["0900", "1000", "1100", "1400", "1500", "1600"].indexOf(data.startTime)] || '—';
    ...
    const timeDisplay = `${tlRaw} – ${displayEndHour}:00 ${endAmPm}`;
    ...
    // Note: We don't have INITIAL_BOOKINGS here easily, but Scheduling.jsx handles the merge if it's the first time.
    // To be safe, let's just merge.
    const updated = { ...bookings, [data.date]: newBooking };
  ...
  if (done) {
    ...
    return (
      <div className="bp-success bp-fade">
        ...
        <button className="bp-btn bp-btn-ghost" onClick={() => navigate('/schedule')}>Back to Schedule</button>
      </div>
    );
  }
  ...
  return (
    <div className="booking-portal-root">
      <div id="booking-portal-container" style={{ borderRadius: 0, minHeight: "100vh" }}>
        {/* SIDEBAR */}
        ...
        <main className="bp-main">
          ...
          <div className="bp-nav-row">
            <button className="bp-btn bp-btn-ghost" onClick={() => step === 1 ? navigate('/schedule') : handleBack}>
